...
type CommunityDeleteActionProps = {
...
export function CommunityDeleteAction({ communityId, communityName, open, onOpenChange }: CommunityDeleteActionProps) {
    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>This permanently removes the community profile. This cannot be undone.</AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          ...
          <AlertDialogAction
            ...
            onClick={async () => {
              try {
                await removeCommunity({ id: communityId });
